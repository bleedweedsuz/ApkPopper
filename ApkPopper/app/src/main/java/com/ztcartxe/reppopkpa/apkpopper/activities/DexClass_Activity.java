...
public class DexClass_Activity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dex_class_);
        ...
        recyclerView = findViewById(R.id.rec_dexclass);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        ArrayList<String> list = LoadDexClass();
        if(list != null) {
            recyclerAdapter = new DexClassAdapter(list);
    ...
    private ArrayList<String> LoadDexClass(){
        try {
            packageFullDetails = new PackageFullDetails(AppDetails_Activity.packageInfoItem);
            ArrayList<String> list = new ArrayList<>();
            for (DexClass dexClass : packageFullDetails.getApkFile().getDexClasses()) {
                list.add(dexClass.toString());
            }
            return list;
        }
    ...
    public class DexClassAdapter extends RecyclerView.Adapter<DexClassAdapter.MyViewHolder> {
        ArrayList<String> mList;

        DexClassAdapter(ArrayList<String> mList) {
            this.mList = mList;
        }
